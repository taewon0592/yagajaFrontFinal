...
public class SearchLodgeDTO {
	...
	//기본생성자
	public SearchLodgeDTO() {}
	//인자생성자
	public SearchLodgeDTO(String lodge_no, String lodge_type, String lodge_name, String lodge_photo, String room_no,
