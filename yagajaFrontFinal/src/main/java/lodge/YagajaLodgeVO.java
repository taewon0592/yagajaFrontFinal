...
public class YagajaLodgeVO {
   ...
   //
   public YagajaLodgeVO() {}
   //
   public YagajaLodgeVO(String lodge_no, String lodge_type, String lodge_name, String lodge_roomcount,
         String lodge_tag, String lodge_thema, String lodge_note, String lodge_feature, String lodge_tel,String lodge_photo, String room_no,
         String room_photo, String room_type, String room_person, String d_rent_price, String d_sleep_price, String w_rent_price,
         String w_sleep_price, String addr_common, String addr_detail, String addr_zipcode, String addr_lat,
         String addr_long) {
      super();
