...
import reservation.ReservationVO;
	...
	public final class SMS {
		 ...
		 * @throws Exception
		 */
		public SMS(String tempKey, String phone, HttpServletRequest req, HttpServletResponse resp) throws Exception {
			
			req.setCharacterEncoding("UTF-8");
			resp.setContentType("text/html; charset=utf-8;");
			
			sms_url = "https://sslsms.cafe24.com/sms_sender.php";
			user_id = base64Encode("esp0107");	//아이디
			secure = base64Encode("95fd63eb8da0f0aba83c9d76fc28c199");// 인증키
			...
			second_phone_number = base64Encode(nullcheck("6479", ""));
			third_phone_number = base64Encode(nullcheck("2505", ""));
			...
			smsType = base64Encode(nullcheck(smsType, "L"));
