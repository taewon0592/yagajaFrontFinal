                ...
                <div class="col-12">
                    <div class="breadcumb-content">
                    	<div class="map-ratings-review-area d-flex">
                           ...
                           <div style="background-color:#FF3479; color:white; width:460px; height:60px; font-size:27px; text-align:center; padding-top:8px; border-radius:15px;" id="diffTime_${dto.auction_no }">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="single-listing-content"> 
						...
						<form action="../auction/auctuinProc.do">
							...
							<c:choose>
								<c:when test="${dto.end_price == '' }">
									<div>
                        				...
                        				<input type="text" value="${dto.start_price }" style="width:140px;" readonly="true"/>
                        			</div>
								</c:when>
								<c:otherwise>
									<div>
