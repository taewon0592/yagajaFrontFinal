			...
			<div class="member-content">
				<section class="login-area">
					<h3 style="font-size:1.5em">
						탈퇴진행을 위해 <br /><font style="color:red"><b></b> 비밀번호</font>를 한 번 더 입력해주세요.
					</h3>
					<form id="confirmForm" name="passcheckFrm" action="../member/memberwithdraw.do?member_no=${sessionScope.siteUserInfo.member_no }&id=${sessionScope.siteUserInfo.id }" method="post" onsubmit="return passValidate()" class="form-group form-w410">
						<fieldset>
